...
This is a Maven project, which uses standard conventions for test and deploy, except that this
does a double release: once for Scala 2.12 and another for Scala 2.13
